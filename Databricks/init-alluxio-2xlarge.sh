...
# this init script default to Alluxio on
ENABLE_ALLUXIO=${ENABLE_ALLUXIO:-'1'}
...
# config file targetting 2xlarge node sizes on AWS
sudo cp /opt/spark-rapids/confs/00-custom-spark-driver-defaults-alluxio-2xlarge.conf /databricks/driver/conf/
